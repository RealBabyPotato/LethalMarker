...
namespace ChairMarkerModTest
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        private void SetupNiceGuy() // FUTURE ME PLEASE DON'T FORGET TO ADD THINGS TO THE ASSET BUNDLE
        {
            ...
            LethalLib.Modules.Enemies.RegisterEnemy(niceGuyType, 1, Levels.LevelTypes.All, LethalLib.Modules.Enemies.SpawnType.Default, tlTerminalNode, tkTerminalKeyword);
        }
